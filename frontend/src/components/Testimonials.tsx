        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div id="testimonial-1" className="bg-gray-900 p-6 rounded-lg border-l-4 border-red-500">
            ...
            <p className="text-gray-300 mb-6">
              "Ambiance incroyable, artistes de talent et organisation au top. Ma nouvelle salle préférée pour découvrir
              des humoristes !"
            </p>
          ...
          <div id="testimonial-2" className="bg-gray-900 p-6 rounded-lg border-l-4 border-red-500">
            ...
            <p className="text-gray-300 mb-6">
              "La billetterie en ligne est super pratique et la salle offre une proximité avec les artistes qu'on ne
              trouve pas ailleurs. Je recommande !"
            </p>
            <div className="flex items-center">
              <img
          ...
          <div id="testimonial-3" className="bg-gray-900 p-6 rounded-lg border-l-4 border-red-500">
            ...
            <p className="text-gray-300 mb-6">
              "J'ai découvert plusieurs artistes grâce à cette salle. La programmation est variée et de qualité. Un lieu
              incontournable pour les amateurs d'humour !"
            </p>
            <div className="flex items-center">
              <img
