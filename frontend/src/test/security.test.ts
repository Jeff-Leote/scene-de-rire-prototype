...
describe('Security Utils', () => {
  ...
  describe('Email Validation', () => {
    ...
    it('should reject invalid email addresses', () => {
      const invalidEmails = ['invalid-email', '@example.com', 'user@', 'user@.com', 'user..name@example.com'];
  ...
  describe('Name Validation', () => {
    it('should validate correct names', () => {
      const validNames = ['John', 'Mary-Jane', "O'Connor", 'José', 'Jean-Pierre'];
  ...
  describe('String Sanitization', () => {
    ...
    it('should preserve safe content', () => {
      const safeInputs = ['Hello World', '123', 'user@example.com', 'Normal text with spaces'];
  ...
  describe('URL Validation', () => {
    ...
    it('should reject disallowed domains', () => {
      const disallowedURLs = ['https://malicious-site.com', 'http://evil.com', 'https://phishing.example.com'];
