...
describe('SecureApiService', () => {
  ...
  describe('Authentication Methods', () => {
    ...
    it('should verify token successfully', async () => {
      ...
      expect(result).toEqual(mockResponse);
      expect(fetch).toHaveBeenCalledWith('http://localhost:5000/api/auth/me', expect.any(Object));
    });
  });
  ...
  describe('Spectacle Methods', () => {
    it('should get all spectacles', async () => {
      ...
      expect(result).toEqual(mockResponse);
      expect(fetch).toHaveBeenCalledWith('http://localhost:5000/api/spectacles', expect.any(Object));
    });
    ...
    it('should get spectacle by ID', async () => {
      ...
      expect(result).toEqual(mockResponse);
      expect(fetch).toHaveBeenCalledWith('http://localhost:5000/api/spectacles/1', expect.any(Object));
    });
  });
  ...
  describe('Artist Methods', () => {
    it('should get all artists', async () => {
      ...
      expect(result).toEqual(mockResponse);
      expect(fetch).toHaveBeenCalledWith('http://localhost:5000/api/artistes', expect.any(Object));
    });
    ...
    it('should get artist by ID', async () => {
      ...
      expect(result).toEqual(mockResponse);
      expect(fetch).toHaveBeenCalledWith('http://localhost:5000/api/artistes/1', expect.any(Object));
    });
  });
