...
export function useSpectacleQuery(id: string | number) {
  return useOptimizedQuery(['spectacle', 'detail', id.toString()], `/api/spectacles/${id}`, {
...
export function useArtistsQuery() {
  return useOptimizedQuery(['artists', 'list'], '/api/artistes', {
...
export function useVenueImagesQuery() {
  return useOptimizedQuery(['venue', 'images'], '/api/lieu/images', {
...
export function useUpcomingShowsQuery() {
  return useOptimizedQuery(['spectacles', 'upcoming'], '/api/spectacles/upcoming', {
...
export function useFeaturedArtistQuery() {
  return useOptimizedQuery(['artist', 'featured'], '/api/artistes/featured', {
