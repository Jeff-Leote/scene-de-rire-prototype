...
const Unsubscribe = () => {
  ...
  const handleDirectUnsubscribe = async (emailToUnsubscribe: string) => {
    try {
      ...
      // Utiliser toujours la route publique pour le désabonnement
        ...
        <main className="max-w-2xl mx-auto px-4 py-12 pt-24">
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            ...
            <div className="mt-8">
              <a
                href="/"
                className="inline-flex items-center px-6 py-3 bg-red-500 hover:bg-red-600 text-white font-medium rounded-lg transition duration-300"
              >
                Retour à l'accueil
              </a>
            </div>
