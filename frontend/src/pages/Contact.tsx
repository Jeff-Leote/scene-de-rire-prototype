              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:lespacecomedie@gmail.com" className="text-red-500 hover:underline cursor-pointer">
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="bg-black bg-opacity-10 hover:bg-opacity-20 text-red-500 p-3 rounded-full transition duration-300 cursor-pointer"
                    aria-label="Google"
                  >
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <label htmlFor="privacy" className="text-sm text-gray-600">
                      ...
                      <span className="text-red-500 hover:underline cursor-pointer">politique de confidentialité</span>.
                    </label>
                    {errors.privacy && (
            ...
            <div className="space-y-6">
              <div className="border-b border-gray-200 pb-4">
                ...
                >
                  ...
                  <ChevronDown
                    className={`text-red-500 transition-transform ${openFaq === 'faq-1' ? 'transform rotate-180' : ''}`}
                  />
                </button>
              ...
              <div className="border-b border-gray-200 pb-4">
                ...
                >
                  Faut-il réserver ?
                  <ChevronDown
                    className={`text-red-500 transition-transform ${openFaq === 'faq-2' ? 'transform rotate-180' : ''}`}
                  />
                </button>
                <div className={`mt-3 text-gray-600 ${openFaq === 'faq-2' ? '' : 'hidden'}`}>
                  <p>
                    ...
                    par e-mail, il suffira de les présenter à l’entrée (version papier ou sur téléphone). Il est parfois
                    possible de payer sur place si des places restent disponibles.
                  </p>
                </div>
              </div>
              ...
              <div className="border-b border-gray-200 pb-4">
                ...
                >
                  ...
                  <ChevronDown
                    className={`text-red-500 transition-transform ${openFaq === 'faq-3' ? 'transform rotate-180' : ''}`}
                  />
                </button>
              ...
              <div className="pb-2">
                ...
                >
                  ...
                  <ChevronDown
                    className={`text-red-500 transition-transform ${openFaq === 'faq-4' ? 'transform rotate-180' : ''}`}
                  />
                </button>
                <div className={`mt-3 text-gray-600 ${openFaq === 'faq-4' ? '' : 'hidden'}`}>
                  <p>
                    ...
                    personnes à mobilité réduite. Nous avons déjà accueilli des spectateurs en fauteuil, aidés par notre
                    équipe pour descendre les escaliers. Si vous êtes concerné, n’hésitez pas à nous contacter en amont
                    afin que nous puissions vous accompagner dans les meilleures conditions possibles.
                  </p>
                </div>
              </div>
            </div>
