export function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" {...props}>
      <path d="M21.35 11.1h-9.17v2.73h6.51c-.33 3.15-2.97 4.51-6.5 4.51-3.93 0-7.14-3.24-7.14-7.24s3.21-7.24 7.14-7.24c3.06 0 4.87 1.94 4.87 1.94l1.87-1.94S16.34 1 12.19 1C6.98 1 2.83 5.24 2.83 11.1s4.15 10.1 9.36 10.1c5.4 0 9.14-3.8 9.14-9.4 0-.63-.06-1.1-.16-1.7z" />
    </svg>
  );
}
...
export function FacebookIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" {...props}>
      <path d="M13.5 21v-7.5H16l.5-3H13.5V8.5c0-.87.24-1.46 1.49-1.46H16.6V4.35c-.26-.04-1.15-.11-2.19-.11-2.17 0-3.66 1.32-3.66 3.75v2.5H8.25v3h2.5V21h2.75z" />
    </svg>
  );
}
