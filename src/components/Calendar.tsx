...
const Calendar = () => {
  return (
    <section id="calendar" className="bg-black py-16">
      <div className="container mx-auto px-6">
        ...
        <div className="bg-gray-900 rounded-lg p-6">
          ...
          <div className="grid grid-cols-7 gap-2">
            ...
            <div className="text-center text-white p-2 relative">
              10
            ...
            <div className="text-center text-white p-2">15</div>
            <div className="text-center text-white p-2 relative group">
              <div className="bg-yellow-400 text-black rounded-full h-8 w-8 flex items-center justify-center mx-auto cursor-pointer">16</div>
            ...
            <div className="text-center text-white p-2">22</div>
            <div className="text-center text-white p-2 relative group">
              <div className="bg-yellow-400 text-black rounded-full h-8 w-8 flex items-center justify-center mx-auto cursor-pointer">23</div>
              <div className="hidden group-hover:block absolute z-10 bottom-full left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs p-2 rounded whitespace-nowrap">
                Adib Alkhalidey - 21h00
              </div>
            </div>
